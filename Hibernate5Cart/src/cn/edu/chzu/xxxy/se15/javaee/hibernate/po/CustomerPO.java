...
public class CustomerPO implements Serializable {
	...
	public CustomerPO(int id, String account, String password, String name, String gender, Date birthday,
	...
	public String toString() {
		return "CustomerPO [id=" + id + ", account=" + account + ", password=" + password + ", name=" + name
