...
<form action="initCartDb" name="dbform" method="post">
	请先选择是否初始化Hibernate5Cart所有数据库及表数据！
...
<form action="customer" name="customer" method="post">
	<br>
	<input type="submit" name="customer" value="提交初始化顾客表" onClick="doAction('/S2H5/customer!listCustomer.action')"/>
</form>
